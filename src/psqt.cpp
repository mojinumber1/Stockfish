...
const Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Knight
   ...
   { S( -71, -50), S(-22,-39), S(  4, -9), S( 13, 27) },
   { S( -25, -41), S( 18,-25), S( 47,  6), S( 51, 37) },
   { S( -26, -46), S( 16,-25), S( 42,  1), S( 54, 40) },
   { S( -11, -55), S( 37,-38), S( 60, -9), S( 75, 26) },
  ...
  { // Bishop
   ...
   { S(-19,-32), S( 17, -9), S( 15,-12), S(  5,  7) },
   { S(-21,-36), S( 18,-13), S( 15,-14), S(  4,  6) },
   { S(-21,-36), S( 14,-14), S( 10,-16), S(  3,  2) },
   { S(-27,-35), S(  6,-13), S(  6, -9), S( -4,  0) },
